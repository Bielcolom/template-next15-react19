...
export default function Sidebar({ cookies, permissions, onVisibilityChange }) {
    ...
    const toggleSidebar = () => {
        ...
        onVisibilityChange(newVisibility); // Llama al callback con el nuevo estado
    };
...
Sidebar.propTypes = {
    ...
    onVisibilityChange: PropTypes.func, // Nueva prop
...
Sidebar.defaultProps = {
    permissions: [],
    cookies: {},
    onVisibilityChange: () => { }, // Callback por defecto
